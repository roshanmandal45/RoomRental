    ...
    <footer className="border-t border-black/10  bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="mb-8">
              <h1 className="text-3xl font-extrabold text-red-700 leading-none">
                ROOM
                
              </h1>
              <span className="ml-[50px] text-red-700 font-semibold text-xl">
                sewa
              </span>
            </div>
        ...
        <div className="border-t border-black/10 mt-14 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-gray-600 text-lg text-center md:text-left">
            © 2026 Room Sewa Pvt. Ltd. All Rights Reserved.
          </p>
